    ...
    <div class="navbar-wrapper">
      <div class="container">
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="top-nav">
            <ul>
                <li><a href="{{ url('login') }}"><img src="images/patients-icon.png"> Patients</a></li>
                <li><a href="{{ url('login') }}"><img src="images/doctor-icon.png"> Doctor</a></li>
                <li><a href="{{ url('login') }}"><img src="images/pharmacies-icon.png"> Pharmacies</a></li>
            </ul>   
          </div>
          <div class="container">
